      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <div className="hero-actions">
            ...
            <Button variant="secondary" size="lg" className="btn-dark" iconLeading={
          ...
          {/* We will add the mockups image below */}
          <div className="hero-mockups">
            {/* Temporary placeholder until we extract the full image */}
